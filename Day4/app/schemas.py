...
class PostResponse(PostBase): # This defines a schema for the response when retrieving a post, it includes fields that client doens't provide.
    ...
    author: UserResponse # This is a nested schema (Relationship Loading) that represents the author of the post, it will include the fields defined in the UserResponse schema. 
